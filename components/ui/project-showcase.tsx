    ...
    <div ref={containerRef} onMouseMove={handleMouseMove} className="relative w-full pb-8 pt-0">
      ...
      <div className="space-y-0">
        {projects.map((project, index) => (
          ...
          >
            <div className={`relative py-5 ${index === 0 ? "pt-2" : "border-t border-border"} transition-all duration-300 ease-out`}>
              ...
              <div className="relative flex flex-col sm:flex-row sm:items-start justify-between gap-2 sm:gap-4">
                <div className="flex-1 min-w-0">
                  {/* Title and year wrapper on mobile */}
                  <div className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-1 sm:gap-4">
                    ...
                    <span
                      className={`
                        text-xs font-mono text-muted-foreground/85 tabular-nums sm:hidden
                        transition-all duration-300 ease-out
                ...
                <span
                  className={`
                    text-xs font-mono text-muted-foreground tabular-nums hidden sm:inline-block shrink-0 sm:mt-1
                    transition-all duration-300 ease-out
