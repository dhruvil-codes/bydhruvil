...
## Technical Skills
- **Core Specialization:** Large Language Models (LLMs), Retrieval-Augmented Generation (RAG), AI Agents, Prompt Engineering, Agentic Workflows.
- **Languages & Frameworks:** Python, FastAPI, TypeScript, JavaScript, Next.js, React, Node.js.
- **Vector Databases:** Qdrant, Pinecone, ChromaDB.
- **Orchestration & Tools:** Docker, Git, LangChain, LlamaIndex, n8n.

---

## Agent & Machine-Readable Endpoints
- **NLWeb Query Endpoint:** `POST https://bydhruvil.in/ask`
