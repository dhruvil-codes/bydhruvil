...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://bydhruvil.in/blog/openai-hackathon",
  },
  openGraph: {
    title: "From 50% Grades to OpenAI Hackathon | Dhruvil Mistry",
    description: "How I went from 50% grades to winning the OpenAI Hackathon. My journey of building AI products and beating 30,000 applicants.",
    url: "https://bydhruvil.in/blog/openai-hackathon",
    type: "article",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "BlogPosting",
            "@id": "https://bydhruvil.in/blog/openai-hackathon#article",
            "isPartOf": {
              "@id": "https://bydhruvil.in/#website"
            },
            "mainEntityOfPage": "https://bydhruvil.in/blog/openai-hackathon",
