          ...
          <div className="mt-10">
            ...
            <div className="border-t border-border pt-4">
              <p className="text-sm sm:text-base text-muted-foreground mb-4">
                To verify my professional activities, projects, and connect with me directly, visit my official profiles:
              </p>
              <ul className="text-sm sm:text-base leading-7 text-muted-foreground tracking-[-0.01em] list-disc list-outside ml-4 space-y-2 font-mono">
                <li>
                  <a
                  ...
                  >
                    Dhruvil Mistry on LinkedIn
                  </a>{" "}
                  — My professional network and technical content creator profile (3,000+ followers).
                </li>
                <li>
                  <a
                    ...
                    className="text-foreground hover:underline"
                  >
                    Dhruvil Mistry on GitHub
                  </a>{" "}
                  — Repository of my open-source code, AI pipelines, and project builds.
                </li>
                <li>
                  <a
                    ...
                    className="text-foreground hover:underline"
                  >
                    Dhruvil Mistry on Peerlist
                  </a>{" "}
                  — Professional portfolio showcase and developer credentials.
                </li>
                <li>
                  <a
                    ...
                    className="text-foreground hover:underline"
                  >
                    Dhruvil Mistry on X / Twitter
                  </a>{" "}
                  — Building in public and sharing thoughts on LLMs and GenAI.
                </li>
              </ul>
            </div>
          </div>
