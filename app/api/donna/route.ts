...
- Shipped projects: Tax Mitra (AI income-tax notice workflow), Nudge (autonomous AI Gmail follow-up agent), Minutz (AI meeting intelligence), Skin Cure (AI dermatology), Clarity (AI reading assistant)
- In progress: Saral AI (Voice AI Receptionist)
- Skills: Next.js, TypeScript, Tailwind CSS, Framer Motion, AI API integration, RAG, Python, FastAPI
